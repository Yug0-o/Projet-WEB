...
<body>
  <div id="mobile-nav" class="modile_navigation_bar">
    <div class="nav-logo">
  ...
  <div class="dashboard_body">
    ...
    <div class="lateral_navigation_bar">
      <div class="nav-logo">
        <a href="homepage.php"><img src="/images/logo-classic.webp" alt="Logo" class="logo"></a>
        <div class="nav-items">
          <p id="nav-stats" onclick="showStats()">Affichage des statistiques</p>
    ...
    <!-- Stats display -->
    <div class="stats_body" id="stats">
      <div class="stats_num">
        <div class="stats_num_container">
          <div class="stat_text">Nombre de personnes avec un stage</div>
          <div class="stat"><?php echo $data['nb_with_internship']; ?></div>
        </div>
        <div class="stats_num_container">
          <div class="stat_text">Nombre de personnes sans stage</div>
          <div class="stat"><?php echo $data['nb_without_internship']; ?></div>
        </div>
        <div class="stats_num_container">
          <div class="stat_text">Stages en attente</div>
          <div class="stat_waiting_internship">
        ...
        <div class="stats_num_container">
          <div class="stat_text">Nombre de stages en favoris</div>
          <div class="stat"><?php echo $data['nb_wishlist']; ?> <?php echo "\u{1f496}"; ?></div>
        </div>
      </div>
      <div class="stats_chart">
        <canvas id="myPieChart" class="stats_piechart"></canvas>
      </div>
    </div>

    <!-- Account information -->
    <div class="account_body" id="comptes">
      <div class="box_table_stats">
        <?php
        try {
          $user = 'root';
          $pass = '';
        ...
        <div class="table_stats">
          ...
          <div class="stats_students">Nombre d'étudiants: <?php echo $student_count; ?></div>
          <div class="stats_promo">Nombre de promotions: <?php echo $promotion_count; ?></div>
        </div>
      </div>
      <div class="CRUD_body">
        <h2 class="CRUD_title">Modification des comptes</h2>
    ...
    <div class="intership_body" id="stages">
      <div class="tables_body">
        <div class="intership_table">
          <?php
          try {
            $user = 'root';
            $pass = '';
      ...
      <div class="CRUD_body">
        <div class="CRUD_internship">
          <h2 class="CRUD_title">Modification des stages</h2>
        ...
        <div class="CRUD_enterprise">
          <h2 class="CRUD_title">Modification des Entreprises</h2>
          ...
          <input list="address-suggestions" id="address" name="address">
